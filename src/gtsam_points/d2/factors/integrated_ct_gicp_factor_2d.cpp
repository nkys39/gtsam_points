...
template class gtsam_points::IntegratedCT_GICPFactor2D_<gtsam_points::GaussianGridMap2D, gtsam_points::PointCloud2D>;
template class gtsam_points::IntegratedCT_GICPFactor2D_<gtsam_points::PointCloud2D, gtsam_points::PointCloud2D>;
